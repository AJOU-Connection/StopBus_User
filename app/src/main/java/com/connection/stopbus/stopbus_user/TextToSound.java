...
public class TextToSound implements TextToSpeech.OnInitListener {
    ...
    public void ttsUnder20(String tsts) {
        Log.d("sb","for ttss : v 20 :".concat(tsts));
        HashMap<String, String> map = new HashMap<>();
        map.put(TextToSpeech.Engine.KEY_PARAM_UTTERANCE_ID, "MessageId");
        tts.speak(tsts, TextToSpeech.QUEUE_FLUSH, map);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public void ttsGreater21(String tsts) {
        Log.d("sb","for ttss : v 21 :".concat(tsts));
        String utteranceId=this.hashCode() + "";
        Log.d("sb","tsts33333333333333333333");
        tts.speak(tsts, TextToSpeech.QUEUE_FLUSH, null, utteranceId);
        Log.d("sb","tsts4444444444444444444444");
    }
